...
RSpec.describe ReportGenerator do
  ...
  describe "perform" do
    ...
    before do
      ...
      @time_record = create(:time_record, user: user, assigned_date: Time.zone.today, spent_time: 0.45)
      @time_record_2 = create(:time_record, created_at: Time.zone.now - 2.hour, assigned_date: Time.zone.today, spent_time: 1.44)
      @time_record_3 = create(:time_record, user: user, assigned_date: Time.zone.today)
      @time_record_4 = create(:time_record, user: user, created_at: Time.zone.now - 1.hour, assigned_date: Time.zone.today - 10.days, spent_time: 3.5)
